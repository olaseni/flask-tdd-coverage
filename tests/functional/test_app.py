...
def test_list_persons_endpoint_no_init(client):
    """
    GIVEN an endpoint
...
def test_add_and_view_person_endpoint(client):
    """
    GIVEN an endpoint
...
def test_edit_person_endpoint(client):
    """
    GIVEN an endpoint
...
def test_remove_person_endpoint(client):
    """
    GIVEN an endpoint
